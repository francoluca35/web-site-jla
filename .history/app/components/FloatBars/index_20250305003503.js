  ...
  return (
    <div className="fixed right-0 top-1/2 transform -translate-y-1/2 flex flex-col space-y-2 z-50">
      ...
      >
        ...
        /> 
        {hovered === 'catalogo' && (
          <span className="absolute bottom-[-20px] text-xs bg-gray-900 text-white px-2 py-1 rounded-md">Catálogo</span>
        )}
      </a>
      ...
      >
        ...
        {hovered === 'whatsapp' && (
          <span className="absolute bottom-[-20px] text-xs bg-green-700 text-white px-2 py-1 rounded-md">WhatsApp</span>
        )}
      </a>
    </div>
  );
