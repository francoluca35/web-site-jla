      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            <h2 className="text-lg text-black font-semibold mb-4">Selecciona una opción</h2>
            <button
              className="bg-green-500 text-white px-4 py-2 mb-2 rounded-lg w-full hover:bg-green-600"
              onClick={() => window.open('https://wa.me/5491131536316?text=' + encodeURIComponent('Hola, necesito presupuesto para una reparación'), '_blank')}
            >
              🛠 Servicio Técnico
            </button>
            <button
              className="bg-blue-500 text-white px-4 py-2 mb-2 rounded-lg w-full hover:bg-blue-600"
              onClick={() => window.open('https://wa.me/5491131536316?text=' + encodeURIComponent('Hola, necesito un presupuesto para un horno'), '_blank')}
            >
              💰 Presupuesto
            </button>
            <button
              className="bg-gray-800 text-white px-4 py-2 rounded-lg w-full hover:bg-gray-700"
              onClick={() => window.open('https://wa.me/5491131536316?text=' + encodeURIComponent('Hola, me gustaría un horno como el del catálogo'), '_blank')}
            >
