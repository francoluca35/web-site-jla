        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            ...
            <button
              ...
              onClick={() => window.open('https://wa.me/5491131536316?text=' + encodeURIComponent('Necesito un presupuesto para un horno'), '_blank')}
            >
              💰 Presupuesto
            </button>
            <button
              className="bg-gray-800 text-white px-4 py-2 rounded-lg w-full hover:bg-gray-700"
              onClick={() => window.open('https://wa.me/5491131536316?text=' + encodeURIComponent('Me gustaría un horno como el del catálogo'), '_blank')}
            >
