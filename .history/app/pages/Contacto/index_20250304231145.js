    ...
    <div className="max-w-6xl mx-auto px-6 py-12 flex flex-col lg:flex-row justify-between items-start">
      ...
      <div className="w-full lg:w-1/2">
        ...
        <p className="text-gray-600 mb-6 w-[90%]">
          ...
          <a href="tel:+541147508805" className="text-blue-500"> (+54) 11-4750-8805</a>
          {' '}o completá el formulario a continuación
        </p>
        <form onSubmit={handleSubmit} className="bg-gray-100 p-6 rounded-lg shadow-md w-[90%]">
          ...
          <button type="submit" className="bg-green-500 text-white px-6 py-3 rounded-lg hover:bg-gray-700">Enviar</button>
        </form>
      </div>
