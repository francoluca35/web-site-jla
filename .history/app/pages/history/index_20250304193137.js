...
const Nosotros = () => {
  return (
    <div className="flex flex-col items-center justify-center p-10 md:flex-row md:p-36">
      ...
      <div className="text-left max-w-lg mb-10 md:mb-0 md:ml-10 z-20">
      ...
      {/* Sección de imágenes superpuestas con efectos interactivos */}
      <div className="relative w-full max-w-md flex justify-center md:w-1/2">
        <Image
          ...
          width={350}
          height={350}
          className="absolute z-10 rounded-lg top-[50px] left-[50%] translate-x-[-50%] transition-transform duration-300 hover:scale-105 hover:z-20"
        />
        <Image
          ...
          width={350}
          height={350}
          className="absolute z-0 rounded-lg top-[-100px] left-[50%] translate-x-[-50%] transition-transform duration-300 hover:scale-105 hover:z-10"
        />
      </div>
    </div>
  );
