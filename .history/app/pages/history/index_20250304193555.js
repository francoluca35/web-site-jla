...
const Nosotros = () => {
  return (
    <div className="flex flex-col-reverse md:flex-row items-center justify-center p-10 md:p-36">
      {/* Sección de imágenes superpuestas */}
      <div className="relative w-full max-w-md flex justify-center md:w-1/2 mb-10 md:mb-0">
        <div className="relative">
          <Image
            ...
            width={350}
            height={450}
            className="absolute z-10 rounded-lg top-[-10px] left-[120px] transition-transform duration-300 hover:scale-105"
          />
          <Image
            ...
            width={350}
            height={450}
            className="relative z-0 rounded-lg top-[-50px] left-[-20px] transition-transform duration-300 hover:scale-105"
          />
        </div>
      </div>
