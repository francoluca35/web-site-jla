...
export default function Clientes() {
  return (
    <div>
          <h2 className="bg-gray-50 uppercase font-light py-2 -mb-1 text-center text-xl font-semibold text-green-500 mb-4">
    ...
    <div className="bg-black py-6">
      ...
      <motion.div
            ...
            transition={{
              ease: 'linear',
              duration: 140, // 🔹 Aumentamos la duración para que se mueva más lento
              repeat: Infinity,
            }}
          >
