...
export default function Clientes() {
  return (
    ...
    <div className="relative bg-black py-10" style={{ backgroundImage: "url('/Assets/clientes/fondo-cliente.png')", backgroundSize: "cover", backgroundPosition: "center", opacity:"80%"}}>
      {/* Carrusel de logos */}
