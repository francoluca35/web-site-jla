...
export default function Producto() {
  return (
    <section className="flex flex-col md:flex-row-reverse items-center justify-between p-8 bg-white rounded-lg shadow-lg max-w-6xl mx-auto">
      {/* Contenido */}
      ...
      {/* Imagen en pantallas grandes a la derecha */}
