...
export default function Producto() {
  return (
    <section className="flex flex-col md:flex-row items-center justify-center p-8 bg-white rounded-lg shadow-lg">
      {/* Imagen */}
      <div className="w-full md:w-1/2">
        <Image
          src="/assets/hornos.png" // Asegúrate de colocar la imagen correcta en la carpeta public
          width={500}
          height={500}
          alt="Producto"
      ...
      <div className="w-full md:w-1/2 p-6 text-gray-800">
        ...
        <button className="bg-[#00FF00] text-white font-bold py-2 px-6 rounded-lg hover:bg-green-600 transition">
          VER PRODUCTOS
        </button>
      </div>
    </section>
