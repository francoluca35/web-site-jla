        ...
        <div className="w-full lg:w-1/3 text-center lg:text-right">
          ...
          <form onSubmit={handleSubscribe} className="mt-4 flex flex-col lg:flex-row items-center lg:justify-end">
            <input 
              ...
              className="p-3 rounded-lg lg:rounded-l-lg text-black w-full lg:w-auto border-2 border-green-400 focus:outline-none"
              required
            />
            <button type="submit" className="bg-green-500 hover:bg-green-600 px-6 py-3 mt-2 lg:mt-0 rounded-lg lg:rounded-r-lg w-full lg:w-auto transition-all font-semibold">Suscribirse</button>
          </form>
        </div>
      </div>
