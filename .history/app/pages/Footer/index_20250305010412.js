...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-12 relative">
        ...
        <div className="w-full lg:w-1/3 text-center lg:text-right">
          ...
          <form onSubmit={handleSubscribe} className="mt-4 flex flex-col lg:flex-row items-center lg:justify-end">
            <input 
              ...
              className="p-3 lg:rounded-l-lg text-black w-full lg:w-auto border border-green-400 focus:outline-none"
              required
            />
      ...
      © 2025 Powered by <span className="text-green-400 font-semibold"><a href='https://deamondd.com' target="_blank" rel="noopener noreferrer">@deamonDD</a> | All rights reserved</span>
      </div>
