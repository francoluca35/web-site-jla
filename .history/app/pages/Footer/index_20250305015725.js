      ...
      <div className="container mx-auto flex flex-col lg:flex-row justify-between items-start px-8">
        ...
        <div className="w-full lg:w-1/3 text-center lg:text-left mb-6 lg:mb-0">
          ...
          <div className="mt-4 flex justify-center lg:justify-start space-x-4">
            ...
            <a href={whatsappLink} className="bg-gray-700 hover:bg-green-500 p-3 rounded-full transition-all">
              <FaWhatsapp className="text-white text-lg" />
            </a>
            <a href="https://www.instagram.com/jlaservice?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" className="bg-gray-700 hover:bg-green-500 p-3 rounded-full transition-all">
