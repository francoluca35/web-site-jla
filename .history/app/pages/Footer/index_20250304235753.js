        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-6 relative">
          ...
          <div>
            ...
            <div className="mt-4 flex space-x-4">
              <a href="#" className="bg-gray-800 hover:bg-green-600 p-3 rounded-lg inline-block">
                <FaFacebookF className="text-green-500 hover:bg-gray-600 text-xl" />
              </a>
              <a href="#" className="bg-gray-800 hover:bg-green-600 p-3 rounded-lg inline-block">
                <FaWhatsapp className="text-green-500 hover:bg-gray-600 text-xl" />
              </a>
              <a href="#" className="bg-gray-800 hover:bg-green-600 p-3 rounded-lg inline-block">
                <FaInstagram className="text-green-500 hover:bg-gray-600 text-xl" />
              </a>
            </div>
          </div>
