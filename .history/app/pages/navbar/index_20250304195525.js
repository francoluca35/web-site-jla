...
function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-gray-400/80' : 'bg-gray-900 bg-opacity-0'}`}>
      <div className="container mx-auto flex items-center justify-between px-4 py-4">
        ...
        <ul
          ...
          } absolute lg:static top-16 left-0 w-full lg:w-auto bg-gray-900 lg:bg-transparent shadow-lg lg:shadow-none p-4 lg:p-0`}
        >
