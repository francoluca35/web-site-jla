    ...
    <>
      <div className="fixed right-0 top-1/2 transform -translate-y-1/2 flex flex-col space-y-2 z-50">
        ...
        >
          ...
          />
          {hovered === "catalogo" && (
            <span className="bottom-[-20px] text-xs text-white px-2 py-1 rounded-md">
              Catálogo
            </span>
          )}
        </a>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            ...
            <button
              ...
              onClick={() =>
                window.open(
                  "https://wa.me/5491131536316?text=" +
                    encodeURIComponent(
                      "Hola, necesito presupuesto para una reparación"
                    ),
                  "_blank"
                )
              }
            ...
            <button
              ...
              onClick={() =>
                window.open(
                  "https://wa.me/5491131536316?text=" +
                    encodeURIComponent(
                      "Hola, necesito un presupuesto para un horno"
                    ),
                  "_blank"
                )
              }
            ...
            <button
              ...
              onClick={() =>
                window.open(
                  "https://wa.me/5491131536316?text=" +
                    encodeURIComponent(
                      "Hola, me gustaría un horno como el del catálogo"
                    ),
                  "_blank"
                )
              }
