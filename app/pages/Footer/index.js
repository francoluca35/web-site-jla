      ...
      <div className="container mx-auto flex flex-col lg:flex-row justify-between items-start px-8">
        ...
        <div className="w-full lg:w-1/3 text-center lg:text-left mb-6 lg:mb-0">
          ...
          <p className="flex items-center justify-center lg:justify-start mb-2">
            <FaMapMarkerAlt className="text-green-400 mr-2" /> Merlo (1722), Bs.
            As.
          </p>
          <p className="flex items-center justify-center lg:justify-start mb-2">
            <FaEnvelope className="text-green-400 mr-2" />{" "}
            serviciotecnicojla@jlatec.com.ar
          </p>
          ...
          <div className="mt-4 flex justify-center lg:justify-start space-x-4">
            <a
              href={whatsappLink}
              target="_blank"
              className="bg-gray-700 hover:bg-green-500 p-3 rounded-full transition-all"
            >
        ...
        <div className="w-full lg:w-1/3 text-center lg:text-right">
          ...
          <form
            ...
            className="mt-4 flex flex-col lg:flex-row items-center lg:justify-end"
          >
            <input
              type="email"
            ...
            <button
              type="submit"
              className="bg-green-500 hover:bg-green-600 px-6 py-3 mt-2 lg:mt-0 lg:rounded-r-lg w-full lg:w-auto transition-all font-semibold"
            >
              Suscribirse
            </button>
          </form>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg text-center">
            ...
            <p className="text-gray-700">
              Recibirá nuestras novedades en su correo electrónico.
            </p>
            <button
              onClick={() => {
                setShowModal(false);
